    ...
    class INAdapter(context: Context, var innerArray: InnerModel)
        ...
        override fun onBindViewHolder(holder: InnerHolder, position: Int) {
           holder.setIsRecyclable(false)
            ...
            holder.apply {
                titleTextView.text = innerListItem.name
                dateTextView.text = "9/12"
        ...
        class InnerHolder(v: View, parent: ViewGroup, inItem: ArrayList<innerListElements>) : RecyclerView.ViewHolder(v), View.OnClickListener, View.OnLongClickListener{
